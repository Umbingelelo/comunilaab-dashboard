...
export class CategoryService {
  ...
  constructor(
    ...
    this.BASE_PATH = `${this.backend}/api/category`;
  ...
  async deleteByStore(store_id: any, params: any) {
    const request: any = await this.http.post(`${this.BASE_PATH}/${store_id}/by/store`, params, this.CONFIG).toPromise();
    return request.data;
  }
